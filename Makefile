...
SRC_DIR ?= $(abspath src)
# KERNEL_DIR sets the path to the SecureOS source directory
...
ifeq ($(PROGRAM),dhrystone)
RISCV_CFLAGS   += -fno-function-sections -fno-data-sections -fno-toplevel-reorder -fno-stack-protector
RISCV_CXXFLAGS += -fno-function-sections -fno-data-sections -fno-toplevel-reorder -fno-stack-protector
else
RISCV_CFLAGS   += -ffunction-sections -fdata-sections -fno-toplevel-reorder -fno-stack-protector
RISCV_CXXFLAGS += -ffunction-sections -fdata-sections -fno-toplevel-reorder -fno-stack-protector
endif
else
RISCV_CFLAGS   += -ffunction-sections -fdata-sections -fno-toplevel-reorder -fno-stack-protector
RISCV_CXXFLAGS += -ffunction-sections -fdata-sections -fno-toplevel-reorder -fno-stack-protector
...
RISCV_CCASFLAGS += -I$(abspath $(BSP_DIR)/install/include/) -I$(KERNEL_DIR)
RISCV_CFLAGS    += -I$(abspath $(BSP_DIR)/install/include/) -I$(KERNEL_DIR)
RISCV_CXXFLAGS  += -I$(abspath $(BSP_DIR)/install/include/) -I$(KERNEL_DIR)
...
RISCV_LDFLAGS += -L$(KERNEL_DIR) -L$(sort $(dir $(abspath $(filter %.a,$^)))) -T$(abspath $(filter %.lds,$^))

# Link to the relevant libraries
RISCV_LDLIBS += -Wl,--start-group -lc -lgcc -lm -lmetal -lkernel $(LIBMETAL_EXTRA) -Wl,--end-group
...
clean: clean-metal clean-kernel
